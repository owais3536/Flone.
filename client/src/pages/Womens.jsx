...
import { womensItemData } from "../../public/data";
...
const Womens = () => {
    ...
    return (
        <main className="container mx-auto">
            ...
            >
                <img src="/women-banner.jpg" alt="" className="w-full h-full object-cover absolute mix-blend-overlay" />
